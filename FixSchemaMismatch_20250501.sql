...
UPDATE [StokFifoKayitlari] SET [ParaBirimi] = N'' WHERE [ParaBirimi] IS NULL;
...
UPDATE [StokCikisDetaylari] SET [ReferansTuru] = N'' WHERE [ReferansTuru] IS NULL;
...
UPDATE [StokCikisDetaylari] SET [ReferansNo] = N'' WHERE [ReferansNo] IS NULL;
...
UPDATE [StokCikisDetaylari] SET [IptalAciklama] = N'' WHERE [IptalAciklama] IS NULL;
...
UPDATE [StokCikisDetaylari] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [SistemLoglar] SET [TabloAdi] = N'' WHERE [TabloAdi] IS NULL;
...
UPDATE [SistemLoglar] SET [Sayfa] = N'' WHERE [Sayfa] IS NULL;
...
UPDATE [SistemLoglar] SET [KullaniciAdi] = N'' WHERE [KullaniciAdi] IS NULL;
...
UPDATE [SistemLoglar] SET [KayitAdi] = N'' WHERE [KayitAdi] IS NULL;
...
UPDATE [SistemLoglar] SET [IslemTuru] = N'' WHERE [IslemTuru] IS NULL;
...
UPDATE [SistemLoglar] SET [IPAdresi] = N'' WHERE [IPAdresi] IS NULL;
...
UPDATE [SistemLoglar] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [SistemAyarlari] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [Menuler] SET [Url] = N'' WHERE [Url] IS NULL;
...
UPDATE [Menuler] SET [Icon] = N'' WHERE [Icon] IS NULL;
...
UPDATE [Menuler] SET [Controller] = N'' WHERE [Controller] IS NULL;
...
UPDATE [Menuler] SET [Action] = N'' WHERE [Action] IS NULL;
...
UPDATE [Kasalar] SET [KasaTuru] = N'' WHERE [KasaTuru] IS NULL;
...
UPDATE [Kasalar] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [KasaHareketleri] SET [ReferansTuru] = N'' WHERE [ReferansTuru] IS NULL;
...
UPDATE [KasaHareketleri] SET [ReferansNo] = N'' WHERE [ReferansNo] IS NULL;
...
UPDATE [KasaHareketleri] SET [KarsiParaBirimi] = N'' WHERE [KarsiParaBirimi] IS NULL;
...
UPDATE [KasaHareketleri] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [IrsaliyeTurleri] SET [HareketTuru] = N'' WHERE [HareketTuru] IS NULL;
...
UPDATE [Irsaliyeler] SET [Durum] = N'' WHERE [Durum] IS NULL;
...
UPDATE [Irsaliyeler] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [IrsaliyeDetaylari] SET [Birim] = N'' WHERE [Birim] IS NULL;
...
UPDATE [IrsaliyeDetaylari] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [GenelSistemAyarlari] SET [SirketVergiNo] = N'' WHERE [SirketVergiNo] IS NULL;
...
UPDATE [GenelSistemAyarlari] SET [SirketVergiDairesi] = N'' WHERE [SirketVergiDairesi] IS NULL;
...
UPDATE [GenelSistemAyarlari] SET [SirketTelefon] = N'' WHERE [SirketTelefon] IS NULL;
...
UPDATE [GenelSistemAyarlari] SET [SirketEmail] = N'' WHERE [SirketEmail] IS NULL;
...
UPDATE [GenelSistemAyarlari] SET [SirketAdresi] = N'' WHERE [SirketAdresi] IS NULL;
...
UPDATE [FaturaTurleri] SET [HareketTuru] = N'' WHERE [HareketTuru] IS NULL;
...
UPDATE [FaturaOdemeleri] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [Faturalar] SET [OdemeDurumu] = N'' WHERE [OdemeDurumu] IS NULL;
...
UPDATE [Faturalar] SET [FaturaNotu] = N'' WHERE [FaturaNotu] IS NULL;
...
UPDATE [Faturalar] SET [DovizTuru] = N'' WHERE [DovizTuru] IS NULL;
...
UPDATE [Faturalar] SET [AklanmaNotu] = N'' WHERE [AklanmaNotu] IS NULL;
...
UPDATE [FaturaAklamaKuyrugu] SET [AklanmaNotu] = N'' WHERE [AklanmaNotu] IS NULL;
...
UPDATE [Depolar] SET [Adres] = N'' WHERE [Adres] IS NULL;
...
UPDATE [Birimler] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [BankaHesaplari] SET [SubeKodu] = N'' WHERE [SubeKodu] IS NULL;
...
UPDATE [BankaHesaplari] SET [SubeAdi] = N'' WHERE [SubeAdi] IS NULL;
...
UPDATE [BankaHesaplari] SET [ParaBirimi] = N'TRY' WHERE [ParaBirimi] IS NULL;
...
UPDATE [BankaHesaplari] SET [IBAN] = N'' WHERE [IBAN] IS NULL;
...
UPDATE [BankaHesaplari] SET [HesapNo] = N'' WHERE [HesapNo] IS NULL;
...
UPDATE [BankaHesaplari] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [ReferansTuru] = N'' WHERE [ReferansTuru] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [ReferansNo] = N'' WHERE [ReferansNo] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [KarsiUnvan] = N'' WHERE [KarsiUnvan] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [KarsiIBAN] = N'' WHERE [KarsiIBAN] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [KarsiBankaAdi] = N'' WHERE [KarsiBankaAdi] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [DekontNo] = N'' WHERE [DekontNo] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [BankaHareketleri] SET [ReferansTuru] = N'' WHERE [ReferansTuru] IS NULL;
...
UPDATE [BankaHareketleri] SET [ReferansNo] = N'' WHERE [ReferansNo] IS NULL;
...
UPDATE [BankaHareketleri] SET [KarsiUnvan] = N'' WHERE [KarsiUnvan] IS NULL;
...
UPDATE [BankaHareketleri] SET [KarsiIBAN] = N'' WHERE [KarsiIBAN] IS NULL;
...
UPDATE [BankaHareketleri] SET [KarsiBankaAdi] = N'' WHERE [KarsiBankaAdi] IS NULL;
...
UPDATE [BankaHareketleri] SET [DekontNo] = N'' WHERE [DekontNo] IS NULL;
...
UPDATE [BankaHareketleri] SET [Aciklama] = N'' WHERE [Aciklama] IS NULL;
...
UPDATE [BankaHesapHareketleri] SET [KarsiParaBirimi] = N'' WHERE [KarsiParaBirimi] IS NULL;
...
ALTER TABLE [Irsaliyeler] ADD [DepoID] uniqueidentifier NULL;

ALTER TABLE [IrsaliyeDetaylari] ADD [DepoID] uniqueidentifier NULL;
...
ALTER TABLE [IrsaliyeDetaylari] ADD CONSTRAINT [FK_IrsaliyeDetaylari_Depolar_DepoID] FOREIGN KEY ([DepoID]) REFERENCES [Depolar] ([DepoID]);

ALTER TABLE [Irsaliyeler] ADD CONSTRAINT [FK_Irsaliyeler_Depolar_DepoID] FOREIGN KEY ([DepoID]) REFERENCES [Depolar] ([DepoID]);

ALTER TABLE [Sozlesmeler] ADD CONSTRAINT [FK_Sozlesmeler_Cariler_CariID] FOREIGN KEY ([CariID]) REFERENCES [Cariler] ([CariID]) ON DELETE NO ACTION;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250501161615_FixSchemaMismatch_20250501', N'9.0.4');
