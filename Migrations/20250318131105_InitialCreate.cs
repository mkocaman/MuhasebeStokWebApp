    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DovizID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dovizler", x => x.DovizID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KayitAdi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    Tarayici = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ...
                    IlgiliID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoftDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DovizKuruID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KaynakParaBirimi = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false, defaultValue: ""),
                    KaynakParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HedefParaBirimi = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false, defaultValue: ""),
                    HedefParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KurDegeri = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    ...
                    Tarih = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Kaynak = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "Manuel"),
                    Aciklama = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Aktif = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    SoftDelete = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SistemAyarlariID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AnaDovizKodu = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "USD"),
                    AnaParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IkinciDovizKodu = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, defaultValue: "UZS"),
                    IkinciParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UcuncuDovizKodu = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, defaultValue: "TRY"),
                    UcuncuParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SirketAdi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "Şirket"),
                    SirketAdresi = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true, defaultValue: ""),
                    SirketTelefon = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValue: ""),
                    SirketEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, defaultValue: ""),
                    SirketVergiNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValue: ""),
                    SirketVergiDairesi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, defaultValue: ""),
                    ...
                    SonDovizGuncellemeTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AktifParaBirimleri = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true, defaultValue: "USD,EUR,TRY,UZS,GBP"),
                    Aktif = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    SoftDelete = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GuncellemeTarihi = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SistemAyarlari_Dovizler_AnaParaBirimiID",
                        column: x => x.AnaParaBirimiID,
                        principalTable: "Dovizler",
                        principalColumn: "DovizID");
                    table.ForeignKey(
                        name: "FK_SistemAyarlari_Dovizler_IkinciParaBirimiID",
                        column: x => x.IkinciParaBirimiID,
                        principalTable: "Dovizler",
                        principalColumn: "DovizID");
                    table.ForeignKey(
                        name: "FK_SistemAyarlari_Dovizler_UcuncuParaBirimiID",
                        column: x => x.UcuncuParaBirimiID,
                        principalTable: "Dovizler",
                        principalColumn: "DovizID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SistemAyarlari_AnaParaBirimiID",
                table: "SistemAyarlari",
                column: "AnaParaBirimiID");

            migrationBuilder.CreateIndex(
                name: "IX_SistemAyarlari_IkinciParaBirimiID",
                table: "SistemAyarlari",
                column: "IkinciParaBirimiID");

            migrationBuilder.CreateIndex(
                name: "IX_SistemAyarlari_UcuncuParaBirimiID",
                table: "SistemAyarlari",
                column: "UcuncuParaBirimiID");
