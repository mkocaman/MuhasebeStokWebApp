        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CariTipi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    Yetkili = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OndalikAyraci = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    BinlikAyraci = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DovizIliskileri_ParaBirimleri_HedefParaBirimiID",
                        column: x => x.HedefParaBirimiID,
                        principalTable: "ParaBirimleri",
                        principalColumn: "ParaBirimiID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DovizIliskileri_ParaBirimleri_KaynakParaBirimiID",
