        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubeKodu = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    HesapNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IBAN = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ParaBirimi = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, defaultValue: "TRY"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HareketTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SirketAdresi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SirketTelefon = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SirketEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SirketVergiNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SirketVergiDairesi = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KasaTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParaBirimleri", x => x.ParaBirimiID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sayfa = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    KayitAdi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    ApplicationUserId = table.Column<string>(type: "varchar(128)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ad = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CariUnvani = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    WebSitesi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Efektif_Alis = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    Efektif_Satis = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    Aktif = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    Silindi = table.Column<bool>(type: "bit", nullable: false),
                    Aciklama = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KurDegerleri", x => x.KurDegeriID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParaBirimiIliskileri", x => x.ParaBirimiIliskiID);
                    table.CheckConstraint("CK_DovizIliski_DifferentCurrencies", "KaynakParaBirimiID <> HedefParaBirimiID");
                    table.ForeignKey(
                        name: "FK_ParaBirimiIliskileri_ParaBirimleri_HedefParaBirimiID",
                        column: x => x.HedefParaBirimiID,
                        principalTable: "ParaBirimleri",
                        principalColumn: "ParaBirimiID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParaBirimiIliskileri_ParaBirimleri_KaynakParaBirimiID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StokMiktar = table.Column<decimal>(type: "decimal(18,3)", nullable: false, defaultValue: 0m),
                    Aktif = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KarsiParaBirimi = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    Tarih = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReferansNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ReferansTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ReferansID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParaBirimi = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    DovizKuru = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OdemeDurumu = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FaturaNotu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    DovizTuru = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    AklanmaNotu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParaBirimiIliskileri_HedefParaBirimiID",
                table: "ParaBirimiIliskileri",
