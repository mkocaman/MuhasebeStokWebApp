        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirimKodu = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    BirimSembol = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "BirlesikModulParaBirimleri",
                columns: table => new
                {
                    ...
                    OndalikAyraci = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    BinlikAyraci = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    OndalikHassasiyet = table.Column<int>(type: "int", nullable: false),
                    AnaParaBirimiMi = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GuncellemeTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OlusturanKullaniciID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SonGuncelleyenKullaniciID = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BirlesikModulParaBirimleri", x => x.ParaBirimiID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenelSistemAyarlari", x => x.SistemAyarlariID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ParaBirimiModuluParaBirimleri",
                columns: table => new
                {
                    ParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Ad = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParaBirimiModuluParaBirimleri", x => x.ParaBirimiID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Mesaj = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Sayfa = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IslemTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LogTuruInt = table.Column<int>(type: "int", nullable: true),
                    ...
                    TabloAdi = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    KayitAdi = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    KayitID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KullaniciId = table.Column<string>(type: "varchar(128)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankaID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HesapAdi = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "BirlesikModulKurDegerleri",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BirlesikModulKurDegerleri", x => x.KurDegeriID);
                    table.ForeignKey(
                        name: "FK_BirlesikModulKurDegerleri_BirlesikModulParaBirimleri_ParaBirimiID",
                        column: x => x.ParaBirimiID,
                        principalTable: "BirlesikModulParaBirimleri",
                        principalColumn: "ParaBirimiID",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "BirlesikModulParaBirimiIliskileri",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BirlesikModulParaBirimiIliskileri", x => x.ParaBirimiIliskiID);
                    table.CheckConstraint("CK_BirlesikModulDovizIliski_DifferentCurrencies", "KaynakParaBirimiID <> HedefParaBirimiID");
                    table.ForeignKey(
                        name: "FK_BirlesikModulParaBirimiIliskileri_BirlesikModulParaBirimleri_HedefParaBirimiID",
                        column: x => x.HedefParaBirimiID,
                        principalTable: "BirlesikModulParaBirimleri",
                        principalColumn: "ParaBirimiID");
                    table.ForeignKey(
                        name: "FK_BirlesikModulParaBirimiIliskileri_BirlesikModulParaBirimleri_KaynakParaBirimiID",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MenuId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RolId = table.Column<string>(type: "varchar(128)", nullable: false),
                    MenuRolID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuRoller", x => new { x.MenuId, x.RolId });
                    table.ForeignKey(
                        name: "FK_MenuRoller_AspNetRoles_RolId",
                        column: x => x.RolId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ad = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CariUnvani = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CariKodu = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CariTipi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    BaslangicBakiye = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    Notlar = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    VarsayilanParaBirimiId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    VarsayilanKurKullan = table.Column<bool>(type: "bit", nullable: false),
                    AktifMi = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    OlusturanKullaniciId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SonGuncelleyenKullaniciId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cariler_ParaBirimiModuluParaBirimleri_VarsayilanParaBirimiId",
                        column: x => x.VarsayilanParaBirimiId,
                        principalTable: "ParaBirimiModuluParaBirimleri",
                        principalColumn: "ParaBirimiID");
                });

            migrationBuilder.CreateTable(
                name: "ParaBirimiModuluKurDegerleri",
                columns: table => new
                {
                    KurDegeriID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    OlusturanKullaniciID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SonGuncelleyenKullaniciID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DekontNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParaBirimiModuluKurDegerleri", x => x.KurDegeriID);
                    table.ForeignKey(
                        name: "FK_ParaBirimiModuluKurDegerleri_ParaBirimiModuluParaBirimleri_ParaBirimiID",
                        column: x => x.ParaBirimiID,
                        principalTable: "ParaBirimiModuluParaBirimleri",
                        principalColumn: "ParaBirimiID");
                });
            ...
            migrationBuilder.CreateTable(
                name: "ParaBirimiModuluParaBirimiIliskileri",
                columns: table => new
                {
                    ParaBirimiIliskiID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KaynakParaBirimiID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParaBirimiModuluParaBirimiIliskileri", x => x.ParaBirimiIliskiID);
                    table.CheckConstraint("CK_DovizIliski_DifferentCurrencies", "KaynakParaBirimiID <> HedefParaBirimiID");
                    table.ForeignKey(
                        name: "FK_ParaBirimiModuluParaBirimiIliskileri_ParaBirimiModuluParaBirimleri_HedefParaBirimiID",
                        column: x => x.HedefParaBirimiID,
                        principalTable: "ParaBirimiModuluParaBirimleri",
                        principalColumn: "ParaBirimiID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParaBirimiModuluParaBirimiIliskileri_ParaBirimiModuluParaBirimleri_KaynakParaBirimiID",
                        column: x => x.KaynakParaBirimiID,
                        principalTable: "ParaBirimiModuluParaBirimleri",
                        principalColumn: "ParaBirimiID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KritikStokSeviyesi = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DovizliListeFiyati = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DovizliMaliyetFiyati = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DovizliSatisFiyati = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    OlusturanKullaniciID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SonGuncelleyenKullaniciID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    GuncellemeTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "BankaHesapHareketleri",
                columns: table => new
                {
                    BankaHesapHareketID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BankaHesapID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BankaID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KaynakKasaID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    HedefKasaID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    KarsiBankaAdi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    KarsiIBAN = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    KarsiParaBirimi = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankaHesapHareketleri", x => x.BankaHesapHareketID);
                    table.ForeignKey(
                        name: "FK_BankaHesapHareketleri_BankaHesaplari_BankaHesapID",
                        column: x => x.BankaHesapID,
                        principalTable: "BankaHesaplari",
                        principalColumn: "BankaHesapID");
                    table.ForeignKey(
                        name: "FK_BankaHesapHareketleri_Bankalar_BankaID",
                        column: x => x.BankaID,
                        principalTable: "Bankalar",
                        principalColumn: "BankaID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankaHesapHareketleri_Cariler_CariID",
                        column: x => x.CariID,
                        principalTable: "Cariler",
                        principalColumn: "CariID");
                    table.ForeignKey(
                        name: "FK_BankaHesapHareketleri_Kasalar_HedefKasaID",
                        column: x => x.HedefKasaID,
                        principalTable: "Kasalar",
                        principalColumn: "KasaID");
                    table.ForeignKey(
                        name: "FK_BankaHesapHareketleri_Kasalar_KaynakKasaID",
                        column: x => x.KaynakKasaID,
                        principalTable: "Kasalar",
                        principalColumn: "KasaID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SozlesmeID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SozlesmeNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SozlesmeTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BitisTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CariID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    VekaletGeldiMi = table.Column<bool>(type: "bit", nullable: false),
                    ResmiFaturaKesildiMi = table.Column<bool>(type: "bit", nullable: false),
                    SozlesmeDosyaYolu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    VekaletnameDosyaYolu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SozlesmeTutari = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SozlesmeDovizTuru = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    Silindi = table.Column<bool>(type: "bit", nullable: false),
                    AnaSozlesmeID = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sozlesmeler", x => x.SozlesmeID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KalanMiktar = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StokFifoKayitlari", x => x.StokFifoID);
                    table.ForeignKey(
                        name: "FK_StokFifoKayitlari_Urunler_UrunID",
                        column: x => x.UrunID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IrsaliyeTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ParaBirimi = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FiyatID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OdenenTutar = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AraToplamDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    KDVToplamDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IndirimTutariDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GenelToplamDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    ResmiMi = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    SozlesmeID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    AklanmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AklanmaNotu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Faturalar_Sozlesmeler_SozlesmeID",
                        column: x => x.SozlesmeID,
                        principalTable: "Sozlesmeler",
                        principalColumn: "SozlesmeID",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StokFifoID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    BirimMaliyet = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    ToplamMaliyet = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    ParaBirimi = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ReferansNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ReferansTuru = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ReferansID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Iptal = table.Column<bool>(type: "bit", nullable: false),
                    IptalTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IptalAciklama = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirimFiyatDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TutarDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    KdvTutariDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IndirimTutariDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    NetTutarDoviz = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AklananMiktar = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AklanmaTamamlandi = table.Column<bool>(type: "bit", nullable: false),
                    BirimID = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IrsaliyeNumarasi = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IrsaliyeTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CariID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FaturaID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DepoID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Aciklama = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IrsaliyeTuru = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Aktif = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                name: "FaturaAklamaKuyrugu",
                columns: table => new
                {
                    AklamaID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FaturaKalemID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UrunID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AklananMiktar = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AklanmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AklanmaNotu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SozlesmeID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    BirimFiyat = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ParaBirimi = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "TL"),
                    DovizKuru = table.Column<decimal>(type: "decimal(18,4)", nullable: false, defaultValue: 1m),
                    OlusturanKullaniciID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GuncelleyenKullaniciID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GuncellemeTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Silindi = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SilmeTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ManuelKayit = table.Column<bool>(type: "bit", nullable: false),
                    ResmiFaturaKalemID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FaturaID = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaturaAklamaKuyrugu", x => x.AklamaID);
                    table.ForeignKey(
                        name: "FK_FaturaAklamaKuyrugu_FaturaDetaylari_FaturaKalemID",
                        column: x => x.FaturaKalemID,
                        principalTable: "FaturaDetaylari",
                        principalColumn: "FaturaDetayID");
                    table.ForeignKey(
                        name: "FK_FaturaAklamaKuyrugu_Faturalar_FaturaID",
                        column: x => x.FaturaID,
                        principalTable: "Faturalar",
                        principalColumn: "FaturaID");
                    table.ForeignKey(
                        name: "FK_FaturaAklamaKuyrugu_Sozlesmeler_SozlesmeID",
                        column: x => x.SozlesmeID,
                        principalTable: "Sozlesmeler",
                        principalColumn: "SozlesmeID");
                    table.ForeignKey(
                        name: "FK_FaturaAklamaKuyrugu_Urunler_UrunID",
                        column: x => x.UrunID,
                        principalTable: "Urunler",
                        principalColumn: "UrunID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankaHesapHareketleri_BankaHesapID",
                table: "BankaHesapHareketleri",
                column: "BankaHesapID");

            migrationBuilder.CreateIndex(
                name: "IX_BankaHesapHareketleri_BankaID",
                table: "BankaHesapHareketleri",
                column: "BankaID");

            migrationBuilder.CreateIndex(
                name: "IX_BankaHesapHareketleri_CariID",
                table: "BankaHesapHareketleri",
                column: "CariID");

            migrationBuilder.CreateIndex(
                name: "IX_BankaHesapHareketleri_HedefKasaID",
                table: "BankaHesapHareketleri",
                column: "HedefKasaID");

            migrationBuilder.CreateIndex(
                name: "IX_BankaHesapHareketleri_KaynakKasaID",
                table: "BankaHesapHareketleri",
                column: "KaynakKasaID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BirlesikModulKurDegerleri_ParaBirimiID",
                table: "BirlesikModulKurDegerleri",
                column: "ParaBirimiID");

            migrationBuilder.CreateIndex(
                name: "IX_BirlesikModulParaBirimiIliskileri_HedefParaBirimiID",
                table: "BirlesikModulParaBirimiIliskileri",
                column: "HedefParaBirimiID");

            migrationBuilder.CreateIndex(
                name: "IX_BirlesikModulParaBirimiIliskileri_KaynakParaBirimiID",
                table: "BirlesikModulParaBirimiIliskileri",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FaturaAklamaKuyrugu_FaturaID",
                table: "FaturaAklamaKuyrugu",
                column: "FaturaID");

            migrationBuilder.CreateIndex(
                name: "IX_FaturaAklamaKuyrugu_FaturaKalemID",
                table: "FaturaAklamaKuyrugu",
                column: "FaturaKalemID");

            migrationBuilder.CreateIndex(
                name: "IX_FaturaAklamaKuyrugu_SozlesmeID",
                table: "FaturaAklamaKuyrugu",
                column: "SozlesmeID");

            migrationBuilder.CreateIndex(
                name: "IX_FaturaAklamaKuyrugu_UrunID",
                table: "FaturaAklamaKuyrugu",
                column: "UrunID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParaBirimiModuluKurDegerleri_ParaBirimiID",
                table: "ParaBirimiModuluKurDegerleri",
                column: "ParaBirimiID");

            migrationBuilder.CreateIndex(
                name: "IX_DovizIliski_KaynakParaBirimiID_HedefParaBirimiID",
                table: "ParaBirimiModuluParaBirimiIliskileri",
                columns: new[] { "KaynakParaBirimiID", "HedefParaBirimiID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParaBirimiModuluParaBirimiIliskileri_HedefParaBirimiID",
                table: "ParaBirimiModuluParaBirimiIliskileri",
                column: "HedefParaBirimiID");

            migrationBuilder.CreateIndex(
                name: "IX_ParaBirimi_Kod",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "StokFifoKayitlari",
                columns: new[] { "UrunID", "KalanMiktar", "Aktif", "Silindi", "Iptal" });
