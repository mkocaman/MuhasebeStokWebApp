...
namespace MuhasebeStokWebApp.Migrations
{
    ...
    [Migration("20250507090849_FaturaSilmeIslemDuzeltme")]
    partial class FaturaSilmeIslemDuzeltme
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MuhasebeStokWebApp.Data.Entities.StokCikisDetay", b =>
                {
                    ...
                    b.HasOne("MuhasebeStokWebApp.Data.Entities.StokFifo", null)
                        .WithMany("StokCikisDetaylari")
                        .HasForeignKey("StokFifoID1");
