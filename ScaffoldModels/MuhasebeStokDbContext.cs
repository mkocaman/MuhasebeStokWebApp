...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=MuhasebeStokDB;User Id=sa;Password=Test1234_;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CariHareketler>(entity =>
        {
            ...
            entity.Property(e => e.Aciklama)
                .IsRequired()
                .HasMaxLength(500);
            entity.Property(e => e.HareketTuru).IsRequired();
            entity.Property(e => e.ReferansId).HasColumnName("ReferansID");
        ...
        modelBuilder.Entity<FaturaTurleri>(entity =>
        {
            ...
            entity.Property(e => e.FaturaTuruAdi)
                .IsRequired()
                .HasMaxLength(50);
        ...
        modelBuilder.Entity<Faturalar>(entity =>
        {
            ...
            entity.Property(e => e.FaturaNumarasi)
                .IsRequired()
                .HasMaxLength(20);
            entity.Property(e => e.FaturaTuruId).HasColumnName("FaturaTuruID");
        ...
        modelBuilder.Entity<GenelSistemAyarlari>(entity =>
        {
            ...
            entity.Property(e => e.SirketAdi)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.SirketAdresi).HasMaxLength(100);
            entity.Property(e => e.SirketEmail).HasMaxLength(100);
            entity.Property(e => e.SirketTelefon).HasMaxLength(20);
            entity.Property(e => e.SirketVergiDairesi).HasMaxLength(20);
            entity.Property(e => e.SirketVergiNo).HasMaxLength(20);
        });
        ...
        modelBuilder.Entity<IrsaliyeTurleri>(entity =>
        {
            ...
            entity.Property(e => e.HareketTuru).HasMaxLength(50);
            entity.Property(e => e.IrsaliyeTuruAdi)
                .IsRequired()
                .HasMaxLength(50);
        });
        ...
        modelBuilder.Entity<Irsaliyeler>(entity =>
        {
            ...
            entity.Property(e => e.FaturaId).HasColumnName("FaturaID");
            entity.Property(e => e.IrsaliyeNumarasi)
                .IsRequired()
                .HasMaxLength(20);
            entity.Property(e => e.IrsaliyeTuru).IsRequired();
            entity.Property(e => e.IrsaliyeTuruId).HasColumnName("IrsaliyeTuruID");
        ...
        modelBuilder.Entity<KurDegerleri>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ParaBirimiId, e.Tarih }, "IX_KurDegeri_ParaBirimiID_Tarih");
            ...
            entity.HasOne(d => d.ParaBirimi).WithMany(p => p.KurDegerleris).HasForeignKey(d => d.ParaBirimiId);
        });
        ...
        modelBuilder.Entity<ParaBirimiIliskileri>(entity =>
        {
            ...
            entity.Property(e => e.OlusturanKullaniciId)
                .IsRequired()
                .HasColumnName("OlusturanKullaniciID");
            entity.Property(e => e.SonGuncelleyenKullaniciId)
                .IsRequired()
                .HasColumnName("SonGuncelleyenKullaniciID");
        ...
        modelBuilder.Entity<ParaBirimleri>(entity =>
        {
            ...
            entity.Property(e => e.Ad)
                ...
                .HasMaxLength(50);
            entity.Property(e => e.Aktif).HasDefaultValue(true);
            entity.Property(e => e.BinlikAyraci)
                .IsRequired()
                .HasMaxLength(1);
            ...
            entity.Property(e => e.OlusturanKullaniciId)
                .IsRequired()
                .HasColumnName("OlusturanKullaniciID");
            entity.Property(e => e.OndalikAyraci)
                .IsRequired()
                .HasMaxLength(1);
        ...
        modelBuilder.Entity<SistemLoglar>(entity =>
        {
            ...
            entity.HasIndex(e => e.ApplicationUserId, "IX_SistemLoglar_ApplicationUserId");
            ...
            entity.Property(e => e.LogTuru)
                .IsRequired()
                .HasMaxLength(50);
            entity.Property(e => e.Mesaj)
                .IsRequired()
                .HasMaxLength(500);
            entity.Property(e => e.Sayfa).HasMaxLength(255);
            entity.Property(e => e.TabloAdi).HasMaxLength(100);

            entity.HasOne(d => d.ApplicationUser).WithMany(p => p.SistemLoglars).HasForeignKey(d => d.ApplicationUserId);
        });
        ...
        modelBuilder.Entity<Urunler>(entity =>
        {
            ...
            entity.Property(e => e.OlusturanKullaniciId).HasColumnName("OlusturanKullaniciID");
            entity.Property(e => e.SonGuncelleyenKullaniciId).HasColumnName("SonGuncelleyenKullaniciID");
            entity.Property(e => e.StokMiktar).HasColumnType("decimal(18, 3)");
