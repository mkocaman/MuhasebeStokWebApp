...
VALUES ('6a3005d9-f404-414a-9c3c-0d6e38356ef1', N'Ana Kasa', N'Merkez', 1000.0, 1000.0, N'Merkez ofis ana kasası', CAST(1 AS bit), '2025-03-18T10:28:22.1250370+05:00', CAST(0 AS bit));
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'KasaID', N'KasaAdi', N'KasaTuru', N'AcilisBakiye', N'GuncelBakiye', N'Aciklama', N'Aktif', N'OlusturmaTarihi', N'SoftDelete') AND [object_id] = OBJECT_ID(N'[Kasalar]'))
...
VALUES ('5cfd7c22-964d-418c-baff-6520d527bc4f', N'Test Bankası', N'Test Şubesi', N'100', N'123456789', N'TR123456789012345678901234', N'TL', 5000.0, 5000.0, N'Test banka hesabı', CAST(1 AS bit), '2025-03-18T10:28:22.1416590+05:00', CAST(0 AS bit));
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'BankaID', N'BankaAdi', N'SubeAdi', N'SubeKodu', N'HesapNo', N'IBAN', N'ParaBirimi', N'AcilisBakiye', N'GuncelBakiye', N'Aciklama', N'Aktif', N'OlusturmaTarihi', N'SoftDelete') AND [object_id] = OBJECT_ID(N'[Bankalar]'))
...
VALUES ('a90ec0cf-b60c-435f-8f36-8b3eb9706bf6', '5cfd7c22-964d-418c-baff-6520d527bc4f', 1000.0, N'Giriş', '2025-03-18T10:28:22.1416620+05:00', N'REF001', N'Havale', N'Test banka hareketi', N'DK001', '2025-03-18T10:28:22.1416620+05:00', CAST(0 AS bit), N'Test Müşteri', N'Test Karşı Banka', N'TR9876543210');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'BankaHareketID', N'BankaID', N'Tutar', N'HareketTuru', N'Tarih', N'ReferansNo', N'ReferansTuru', N'Aciklama', N'DekontNo', N'OlusturmaTarihi', N'SoftDelete', N'KarsiUnvan', N'KarsiBankaAdi', N'KarsiIBAN') AND [object_id] = OBJECT_ID(N'[BankaHareketleri]'))
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'DovizID', N'DovizKodu', N'DovizAdi', N'Sembol', N'Aktif', N'SoftDelete', N'OlusturmaTarihi') AND [object_id] = OBJECT_ID(N'[Dovizler]'))
    SET IDENTITY_INSERT [Dovizler] ON;
INSERT INTO [Dovizler] ([DovizID], [DovizKodu], [DovizAdi], [Sembol], [Aktif], [SoftDelete], [OlusturmaTarihi])
VALUES ('f1a8b9f4-27ad-4cbc-bf3a-42ad684600c6', N'TRY', N'Türk Lirası', N'₺', CAST(1 AS bit), CAST(0 AS bit), '2025-03-18T10:28:23.0404350+05:00'),
('85f32ff7-e2f1-4172-8ae9-6e8001756edd', N'USD', N'Amerikan Doları', N'$', CAST(1 AS bit), CAST(0 AS bit), '2025-03-18T10:28:23.0404390+05:00'),
('af4387b9-c3ca-4f39-892f-834347543ce9', N'EUR', N'Euro', N'€', CAST(1 AS bit), CAST(0 AS bit), '2025-03-18T10:28:23.0404400+05:00'),
('797f8198-0530-47ee-9b68-39c3ab952e57', N'GBP', N'İngiliz Sterlini', N'£', CAST(1 AS bit), CAST(0 AS bit), '2025-03-18T10:28:23.0404410+05:00'),
('d8bdb144-6c4d-479a-96cd-af1cf87cf35e', N'UZS', N'Özbekistan Somu', N'SO''M', CAST(1 AS bit), CAST(0 AS bit), '2025-03-18T10:28:23.0404410+05:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'DovizID', N'DovizKodu', N'DovizAdi', N'Sembol', N'Aktif', N'SoftDelete', N'OlusturmaTarihi') AND [object_id] = OBJECT_ID(N'[Dovizler]'))
    SET IDENTITY_INSERT [Dovizler] OFF;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250318052655_CreateDovizlerTable', N'9.0.2');
